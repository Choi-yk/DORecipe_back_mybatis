...
//       console.log("MemberInfoForm", user.auth.user.username);
...
//   function Axios() {
//     axios({
//       // url: "/member/info/" + user.auth.user.username,
//       url: "api/auth/member/info/" + currentId,
//       method: "get",
//       data: {
//         member_id: currentId,
//         member_pwd: "",
...
//             "http://localhost:3000/member/info/" + memberId;
//         });
//       }
//     },
//     [memberId]
...
//                 <SubmitRecipeBtn>취소</SubmitRecipeBtn>
//               </Link>
//             </li>
//             <li>
